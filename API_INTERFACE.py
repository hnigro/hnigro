...
este archivo corresponde al API_INTERFACE2
...
acá comienza la funcion para generar los datos de BW hacia http
...
if __name__ == "__main__":
    ...
    #app.run(debug= True)
    app.run(debug = True, host="127.0.0.1", port=16000)
"""
...
Termina la funcion para generar los datos de BW hacia http
