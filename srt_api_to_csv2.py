# le agrego al prinmcipal una funcion Generacion_CSV(SRT_IP):
...
def API_swagger(CSV_file="SRT-ABC-OTT-05.csv"):
    ...
    #xxx
    log_file.write(f"respuesta = {swagger_response.text}\n")
    log_file.write(f"código = {cod_salida}\n")
...
def Generacion_CSV(SRT_IP):
    ...
    #xxx
    log_file.write(f"nombre del archivo creado = {filew.name}\n")
    ...
    for svalue in sroutes:
        ...
        if len(ROUTE_NAME) > 3:
            ...
            #xxx
            log_file.write(f"{len(ROUTE_NAME)}\n")
    ...
    while True:
        ...
        # ********************************************************************************
            ...
            while True:
                ...
                #aqui comienzan las nuevas lineas
...
global log_file
log_file = open(f"CSV_FILES\\log_file.txt", "w")
log_file.write(f"logfilw\n")
...
try:
    ...
    #xxx
    log_file.write(f"{errorh1.__str__()}\n")
