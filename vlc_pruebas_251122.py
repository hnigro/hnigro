...
def main():
    ...
    #Esta instrucción es para abrir un mosaico con vlm
    vlm_mosaic = subprocess.Popen(["vlc.exe", "-vvv", "--vlm-conf",path1.mosaic_vlm])

    """el siguiente ejemplo hace lo mismo pero le tengo que poner shell =True y va sin la lista de argumentos (solo separo por espacios)
    vlm_mosaic = subprocess.Popen("vlc.exe" + " "+ "-vvv"+ " "+ "--vlm-conf" + " " + path1.mosaic_vlm ,shell=True)
    """
